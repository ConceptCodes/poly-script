...
class TranscriptionJob(Base, TimestampMixin):
    ...
    audio_asset: Mapped["AudioAsset"] = relationship(back_populates="job", uselist=False, cascade="all, delete-orphan")
    transcript: Mapped["Transcript"] = relationship(back_populates="job", uselist=False, cascade="all, delete-orphan")
