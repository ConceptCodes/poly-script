...
def upgrade() -> None:
    op.add_column('transcription_jobs', sa.Column('started_at', sa.DateTime(timezone=True), nullable=True))
    op.add_column('transcription_jobs', sa.Column('finished_at', sa.DateTime(timezone=True), nullable=True))
