...
class ErrorDetail(BaseModel):
    ...
    code: str | None = Field(None, description="Field-specific error code")
...
class APIError(Exception):
    ...
    def __init__(
        ...
        options: APIErrorOptions | None = None,
    ):
        options = options or APIErrorOptions()
        self.code = code
        self.message = message
        self.status_code = options.status_code
        self.severity = options.severity
        self.details = details or []
        self.documentation_url = options.documentation_url
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "details": [detail.model_dump(exclude_none=True) for detail in self.details]
            if self.details
            else None,
