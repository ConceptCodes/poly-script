...
from ..interface import TranscriptionResult, Segment, EngineCapabilities
from ..normalizer import normalize_language_code
...
class TranslateGemmaEngine:
    ...
    def __init__(self):
        ...
        print(f"[TranslateGemma] Loaded model '{self._model_name}' on device: {self._device}")
    ...
    def _extract_translation(self, response: str) -> str:
        ...
        for line in lines:
            ...
            elif line and (line.startswith("user>") or line.startswith("User:")):
                in_translation = False
        ...
        for line in reversed(lines):
            if line.strip() and not any(
                ...
                for marker in ["user>", "model>", "user:", "model:"]
            ):
                return line.strip()
    ...
    def _get_supported_languages(self) -> List[str]:
        ...
        return [
            ...
            "nl", "pl", "tr", "sv", "da", "no", "fi", "cs", "el", "hu",
            "ar", "hi", "th", "vi", "id", "ms", "uk", "he", "ro", "bg",
        ]
