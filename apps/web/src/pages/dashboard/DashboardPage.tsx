    ...
    <div className="bg-muted/30 min-h-screen pb-12">
      <div className="max-w-7xl mx-auto px-6 pt-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 mb-10">
          ...
          <Button asChild className="text-base px-8 py-4 h-12 shadow-lg bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card>
            ...
            <div className="p-6 pt-2">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <Link to="/upload" className="flex items-center gap-3.5 p-4 bg-card border border-border rounded-xl hover:bg-muted hover:border-primary hover:-translate-y-0.5 hover:shadow-md transition-all">
                  <div className="flex items-center justify-center w-10 h-10 bg-gradient-to-r from-primary to-accent text-white rounded-xl flex-shrink-0 text-xl">📁</div>
                  <div>
                ...
                <Link to="/jobs" className="flex items-center gap-3.5 p-4 bg-card border border-border rounded-xl hover:bg-muted hover:border-primary hover:-translate-y-0.5 hover:shadow-md transition-all">
                  <div className="flex items-center justify-center w-10 h-10 bg-gradient-to-r from-primary to-accent text-white rounded-xl flex-shrink-0 text-xl">🔍</div>
                  <div>
                    <h4 className="font-semibold text-foreground">
                ...
                <Link to="/billing" className="flex items-center gap-3.5 p-4 bg-card border border-border rounded-xl hover:bg-muted hover:border-primary hover:-translate-y-0.5 hover:shadow-md transition-all">
                  <div className="flex items-center justify-center w-10 h-10 bg-gradient-to-r from-primary to-accent text-white rounded-xl flex-shrink-0 text-xl">💳</div>
                  <div>
                    <h4 className="font-semibold text-foreground">
                ...
                <Link to="/settings/team" className="flex items-center gap-3.5 p-4 bg-card border border-border rounded-xl hover:bg-muted hover:border-primary hover:-translate-y-0.5 hover:shadow-md transition-all">
                  <div className="flex items-center justify-center w-10 h-10 bg-gradient-to-r from-primary to-accent text-white rounded-xl flex-shrink-0 text-xl">👥</div>
                  <div>
                    <h4 className="font-semibold text-foreground">
          ...
          <Card>
            ...
            <div className="p-6 pt-2">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <Link to="/settings/user" className="flex items-center gap-3.5 p-4 bg-card border border-border rounded-xl hover:bg-muted hover:border-primary hover:-translate-y-0.5 hover:shadow-md transition-all">
                  <div className="flex items-center justify-center w-10 h-10 bg-gradient-to-r from-primary to-accent text-white rounded-xl flex-shrink-0 text-xl">👤</div>
                  <div>
                    <h4 className="font-semibold text-foreground">
                ...
                <Link to="/settings/team" className="flex items-center gap-3.5 p-4 bg-card border border-border rounded-xl hover:bg-muted hover:border-primary hover:-translate-y-0.5 hover:shadow-md transition-all">
                  <div className="flex items-center justify-center w-10 h-10 bg-gradient-to-r from-primary to-accent text-white rounded-xl flex-shrink-0 text-xl">⚙️</div>
                  <div>
                    <h4 className="font-semibold text-foreground">
