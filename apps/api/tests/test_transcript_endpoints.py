...
class TestListTranscriptsEndpoint:
    ...
    def test_list_transcripts_with_data(self, mock_current_team_id, mock_db_session, sample_transcript):
...
class TestGetTranscriptEndpoint:
    ...
    def test_get_transcript_success(self, mock_current_team_id, sample_transcript_id, sample_transcript):
    ...
    def test_get_transcript_forbidden(self, mock_current_team_id, sample_transcript_id, sample_transcript):
...
class TestUpdateTranscriptEndpoint:
    ...
    def test_update_transcript_success(self, mock_current_team_id, mock_current_user_id, sample_transcript_id, sample_transcript):
    ...
    def test_update_transcript_invalid_body(self, mock_current_team_id, mock_current_user_id, sample_transcript_id):
...
class TestGetTranscriptSegmentsEndpoint:
    ...
    def test_get_segments_success(self, mock_current_team_id, sample_transcript_id, sample_transcript):
...
class TestUpdateSegmentEndpoint:
    ...
    def test_update_segment_success(self, mock_current_team_id, mock_current_user_id, sample_transcript_id, sample_transcript):
    ...
    def test_update_segment_not_found(self, mock_current_team_id, mock_current_user_id, sample_transcript_id):
...
class TestRevertTranscriptEndpoint:
    ...
    def test_revert_success(self, mock_current_team_id, mock_current_user_id, sample_transcript_id, sample_transcript):
    ...
    def test_revert_no_edits(self, mock_current_team_id, mock_current_user_id, sample_transcript_id, sample_transcript):
...
class TestExportTranscriptEndpoint:
    ...
    def test_export_srt(self, mock_current_team_id, sample_transcript_id, sample_transcript):
        ...
        with patch("src.routes.transcripts.get_transcript_with_team_check") as mock_get:
            ...
            with patch("src.routes.transcripts.ExportService") as mock_export:
                mock_export.export_transcript.return_value = "1\n00:00:00,000 --> 00:00:05,000\nHello"
                mock_export.get_export_content_type.return_value = "text/plain"
